...
const styles = {
  ...
  card: (accent, hovered) => ({
    ...
    borderRadius: 20,
    padding: '32px 28px 60px', // extra bottom padding so centered arrow doesn't overlap text
    cursor: 'pointer',
  ...
  arrow: (accent, hovered) => ({
    position: 'absolute', bottom: 24, left: '50%', width: 32, height: 32,
    borderRadius: '50%',
...
const cards = [
  ...
  {
    key: 'department-consultancy-installments',
    accent: '#f59e0b',
    title: 'Add Installment',
    desc: 'Enter installment particulars and charges for consultancies submitted with an installment-based payment plan.',
    icon: (
      <>
  ...
  {
  key: 'department-invoice-status', // 'center-invoice-status' in CenterConsultancies.jsx
  accent: '#0f766e',
  title: 'Invoice Status',
  desc: 'Proforma-invoice consultancies — All / Submitted / Completed, with the printable invoice letter.',
  icon: (
    <>
...
{
  key: 'department-payment-status', // 'center-payment-status' in CenterConsultancies.jsx
  accent: '#db2777',
  title: 'Payment Status',
  desc: 'Consultancies with an issued invoice — add payment particulars and generate the Pay-In Slip.',
  icon: (
    <>
